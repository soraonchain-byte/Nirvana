...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 bg-background/80 backdrop-blur-xl border-b border-hairline-soft">
        ...
        <div className="flex items-center gap-4">
          ...
          {authenticated ? (
            <>
              ...
              <button
                onClick={logout}
                className="border border-hairline text-on-surface-variant font-mono text-xs font-bold px-4 py-2 rounded-sm hover:bg-surface-2 transition-all uppercase"
              >
                Disconnect
              </button>
            </>
